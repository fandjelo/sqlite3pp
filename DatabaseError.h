...
public:
    DatabaseError(const std::string& what) noexcept 
...
public:
    ...
    : DatabaseError{ "Failed to open database: " + fileName }
...
public:
    ...
    : DatabaseError{ "Failed to prepare statement: " + what } 
    , m_sql{std::move(sql)} {}
...
public:
    ...
    : DatabaseError("Result type mismatch in column " + std::to_string(index))
    , m_index{index} {}
